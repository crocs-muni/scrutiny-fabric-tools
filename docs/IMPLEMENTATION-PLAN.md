...
| `resolve` | BD-9, PT-5/PT-6/PT-8/PT-9, IX-3, H-1/H-2, CHN-1…3, RL-3/RL-5, RC-1…5, SF-1…7, OV-2…4/OV-6/OV-8/OV-9, DEL-1…3/DEL-6/DEL-7 | **Reads no trust state** (D25). `ChainState.forked` has **no `tipId`** — makes SF-4 unrepresentable. RC-5, SF-7, OV-9, RL-5 are new in spec v0.6.1; SF-7 and OV-9/RL-5 codify design calls this module already made (SPEC-FEEDBACK F10/F11). RC-5 exposed a real bug — see fix/spec-v061-drift |
